...
public class UserController {
    ...
    @PutMapping("/{id}")
    public ResponseEntity<ResponseGlobal> update(Long id,
            UserUpdate userUpdate) throws Exception {
        useCase.updateUser(id, userUpdate);
        return Response.buildV1("Success update user");
    }

    @DeleteMapping("/{id}")
    public ResponseEntity<ResponseGlobal> update(Long id) throws Exception {
